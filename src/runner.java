public class runner {
    ...
    private int count; //better use it
    private String word;
        public String generate() { //no return
    ...
    public void wordCheck (String word,String g1){
        ...
        public boolean gameEnder(int g, String g1){
            if (g>5 || word.equals(g1)){ //end conditions
                return true;
            }
            if (g<=5 && word.equals(g1)){ //fix this pls arden
                return true;
            }
            else {
